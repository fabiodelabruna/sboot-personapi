...
public class PersonUtils {
    ...
    public static PersonDTO createFakeDTO() {
        return PersonDTO.builder().id(PERSON_ID).firstName(FIRST_NAME).lastName(LAST_NAME).cpf(CPF_NUMBER).birthDate("01-10-2010")
    ...
    public static String asJsonString(final PersonDTO personDTO) {
        try {
